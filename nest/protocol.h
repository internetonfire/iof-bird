...
struct proto_stats {
  ...
  u32 imp_updates_best_substitution; /* Number of route updates that change the best route */
  u32 imp_updates_removed_route; /* Number of route updates that change the best route */
